...
{
    public partial class AnimationMoveImage : Image
    {
        ...
        public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(AnimationMoveImage));
        ...
        public static readonly BindableProperty CommandProperty = BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(AnimationMoveImage));
        ...
        public void Begin() => this.Storyboard.Commit(this, nameof(Storyboard), 16, 300, Easing.CubicOut, this.Completed, this.Repeat);
